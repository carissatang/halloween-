...
def draw():
    ...
    fill(255)
    ellipse(x-125,275,10,10)
    ellipse(x-75,275,10,10)
    ...
    fill(0)
    ellipse(750,480,35,35)
    
    ellipse(805,490,25,20)
    ...
    triangle(745,464,730,460,736,470)
    triangle(755,464,770,460,764,474)
    
    fill(0,255,0)
    ellipse(743,480,10,10)
    ellipse(758,480,10,10)
